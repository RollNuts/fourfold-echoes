...
| D-004 | Use MCP for Unity as an editor automation bridge. | Accepted | AI agents need scene inspection, console logs, test runs, and controlled editor operations. MCP is an assistant workflow tool, not proof that gameplay feels good. Runtime evidence still requires running the game. |
