...
- `MeleeShardlingAnimationEventRelay.CueRaised` dispatches typed cue payloads for all 22 AnimationEvents, allowing gameplay, VFX, and audio subscribers to bind without parsing strings.
