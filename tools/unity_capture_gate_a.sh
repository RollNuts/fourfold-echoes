...
FOURFOLD_EVIDENCE_DIR="${FOURFOLD_EVIDENCE_DIR:-${TMPDIR:-/tmp}/fourfold-echoes-evidence}"
...
"$UNITY_EDITOR" \
  ...
  -executeMethod FourfoldEchoes.Editor.FourfoldUnityEvidenceCapture.CaptureGateA \
  -logFile -

echo "Gate A camera evidence: $FOURFOLD_EVIDENCE_DIR/gate-a-camera.png"
